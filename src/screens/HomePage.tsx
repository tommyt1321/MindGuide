...
import { MOOD_COLORS, CATEGORIES, MOODS } from '../constants/data';
...
export default function HomePage({ navigation }: any) {
	...
	const handleMoodSelect = (mood: Mood) => {
		...
		}).start(() => setCurrentColors(MOOD_COLORS[mood.id]));
	};
	...
	return (
		<View style={styles.main}>
			...
			{/* --- REUSABLE HEADER --- */}
			<HeaderBar title="Home" showExit={true} />
			...
			<ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
				...
				{selectedMood && (
					<View style={styles.guidanceCard}>
						...
						{selectedMood.route && (
							<TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate(selectedMood.route as string)}>
